...
{{
  ...
  "jira": {{
    "summary": "[ACCR] {service_name}: adapt to breaking api-core contract change",
    "description_text": "<Write a clear Jira description covering: what upstream change landed in api-core, what broke in {service_name}, what this PR fixes, and which files were changed. Include the PR link and CI status.>"
  }},
  "slack": {{
