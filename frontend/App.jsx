...
function buildOpenApiTriggerDiffHunks() {
  return [
    {
      id: "Breaking #1",
      title: "A new required priority field on session creation",
      lines: [
    ...
    {
      id: "Breaking #2",
      title: "Response fields moved under a nested usage object",
      lines: [
    ...
    {
      id: "Breaking #3",
      title: "total_cost renamed to billing.total",
      lines: [
        "@@ GET /sessions response @@",
        "- total_cost:",
        "-   type: number",
